package com.ndhzs.share_element2.four;
...
import com.ndhzs.share_element2.databinding.ActivityRevealBinding;
...
public class RevealActivity extends BaseActivity implements View.OnClickListener, View.OnTouchListener {
    ...
    private void animateButtonsIn() {
        for (int i = 0; i < binding.revealRoot.getChildCount(); i++) {
            ...
            view.animate().setStartDelay(100 + (long) i * DELAY).setInterpolator(interpolator).alpha(1).scaleX(1).scaleY(1);
        }
    }
